// Seed catalog — used to initialise the products data file on first run.
// Mirrors the frontend catalog (cart-core.js) so the API and UI start in sync.
export const SEED_PRODUCTS = [
  { id: 1, name: "AeroBook Pro 14", brand: "Aero", category: "Laptops", price: 1499.00, rating: 4.8, emoji: "💻", stock: 12,
  ...
  { id: 2, name: "AeroBook Air 13", brand: "Aero", category: "Laptops", price: 999.00, rating: 4.6, emoji: "💻", stock: 25,
  ...
  { id: 3, name: "Nimbus Gaming Laptop", brand: "Nimbus", category: "Laptops", price: 1899.00, rating: 4.7, emoji: "💻", stock: 5,
  ...
  { id: 4, name: "Pulse X Smartphone", brand: "Pulse", category: "Phones", price: 899.00, rating: 4.5, emoji: "📱", stock: 40,
  ...
  { id: 5, name: "Pulse Lite Smartphone", brand: "Pulse", category: "Phones", price: 449.00, rating: 4.2, emoji: "📱", stock: 0,
  ...
  { id: 6, name: "Pulse Ultra 5G", brand: "Pulse", category: "Phones", price: 1199.00, rating: 4.9, emoji: "📱", stock: 8,
  ...
  { id: 7, name: "EchoBuds Pro", brand: "Echo", category: "Audio", price: 199.00, rating: 4.6, emoji: "🎧", stock: 60,
  ...
  { id: 8, name: "SonicWave Headphones", brand: "Sonic", category: "Audio", price: 279.00, rating: 4.7, emoji: "🎧", stock: 18,
  ...
  { id: 9, name: "BoomBox Mini Speaker", brand: "Boom", category: "Audio", price: 89.00, rating: 4.3, emoji: "🔊", stock: 33,
  ...
  { id: 10, name: "Vortex Console X", brand: "Vortex", category: "Gaming", price: 499.00, rating: 4.8, emoji: "🎮", stock: 0,
  ...
  { id: 11, name: "Vortex Wireless Pad", brand: "Vortex", category: "Gaming", price: 69.00, rating: 4.4, emoji: "🎮", stock: 50,
  ...
  { id: 12, name: "RayCast 4K Monitor", brand: "RayCast", category: "Gaming", price: 549.00, rating: 4.6, emoji: "🖥️", stock: 9,
  ...
  { id: 13, name: "HomeHub Smart Speaker", brand: "HomeHub", category: "Smart Home", price: 129.00, rating: 4.1, emoji: "🏠", stock: 22,
  ...
  { id: 14, name: "GlowBulb Smart Light", brand: "Glow", category: "Smart Home", price: 29.00, rating: 4.0, emoji: "💡", stock: 120,
  ...
  { id: 15, name: "SecureCam 2K", brand: "Secure", category: "Smart Home", price: 149.00, rating: 4.5, emoji: "📷", stock: 14,
  ...
  { id: 16, name: "ChronoWatch Series 6", brand: "Chrono", category: "Wearables", price: 399.00, rating: 4.7, emoji: "⌚", stock: 16,
  ...
  { id: 17, name: "FitBand Active", brand: "Chrono", category: "Wearables", price: 99.00, rating: 4.2, emoji: "⌚", stock: 45,
  ...
  { id: 18, name: "PowerCell 20K Battery", brand: "PowerCell", category: "Accessories", price: 49.00, rating: 4.6, emoji: "🔋", stock: 80,
